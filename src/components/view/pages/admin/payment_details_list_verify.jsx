...
import { getPaymentRequestData } from '../../../controller/agent_data_controller.js';
import { AppContext } from '../../../provider.jsx'
import { PaymentDetailsVerify } from './payment_details_verify.jsx';

export const PaymentDetailsVerifyList = () => {
    ...
    const fetchData = async () => {
        ...
        const pendingCount = paymentRequestList.filter(item => item[8] === 'Pending').length;
        const completedCount = paymentRequestList.filter(item => item[8] === 'Verified').length;
    ...
    if (pageIndex == 1) return <PaymentDetailsVerify
                ...
                <div className='content-div-demo'>
                    <div style={{ display: 'flex' }}>
                        ...
                        <div className='request-count-div'>
                            ...
                            <p className='request-count-type'>Verified</p>
                        </div>
                        <div className='request-count-div'>
